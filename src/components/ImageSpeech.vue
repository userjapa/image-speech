  ...
  <div class="game">
    ...
    <div class="game__speech">
      ...
      <div class="game__speech__text">
        ...
        <div :style="{ visibility: (question.answered && !question.hit)?'visible':'hidden' }">
...
export default {
  ...
  data () {
    return {
      ...
      questions: [{
        text: 'Motorcycle',
        img: 'http://motorcycle.com.vsassets.com/blog/wp-content/uploads/2018/03/030918-2018-Royal-Enfield-Himalayan-f.jpg',
        answered: false,
        hit: false
      }],
      question: {},
